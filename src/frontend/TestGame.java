...
public class TestGame extends Application {
    ...
    @Override
    public void init() {
        brickTile = new Image("CatanAI/resources/brick.png");
        desertTile = new Image("CatanAI/resources/desert.png");
        oreTile = new Image("CatanAI/resources/ore.png");
        wheatTile = new Image("CatanAI/resources/wheat.png");
        pastureTile = new Image("CatanAI/resources/pasture.png");
        forestTile = new Image("CatanAI/resources/forest.png");
    ...
    private void initHexagons() {
        ...
        // Second Row 4 tiles
        tiles[3] = new Hexagon(tiles[0].getCenterX() - TILE_RADIUS, tiles[0].getCenterY() + TILE_RADIUS + (TILE_RADIUS / 2));
        ...
        // Third Row 5 tiles
        tiles[7] = new Hexagon(tiles[3].getCenterX() - TILE_RADIUS, tiles[3].getCenterY() + TILE_RADIUS + (TILE_RADIUS / 2));
