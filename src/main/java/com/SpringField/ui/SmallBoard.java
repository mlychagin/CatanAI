...
public class SmallBoard extends Board {
    ...
    public SmallBoard(BoardState initialState) {
        ...
        tiles[1] =
                new Hexagon(
                        tiles[0].getCenterX() + (TILE_RADIUS * 2),
                        tiles[0].getCenterY(),
                        1,
                        points[2],
                        points[3],
        ...
        tiles[2] =
                new Hexagon(
                        tiles[1].getCenterX() + (TILE_RADIUS * 2),
                        tiles[1].getCenterY(),
                        2,
                        points[4],
                        points[5],
        ...
        tiles[3] =
                new Hexagon(
                        tiles[0].getCenterX() - TILE_RADIUS,
        ...
        tiles[4] =
                new Hexagon(
                        tiles[3].getCenterX() + TILE_RADIUS * 2,
                        tiles[3].getCenterY(),
                        4,
                        points[9],
                        points[10],
        ...
        tiles[5] =
                new Hexagon(
                        tiles[4].getCenterX() + TILE_RADIUS * 2,
                        tiles[4].getCenterY(),
                        5,
                        points[11],
                        points[12],
        ...
        tiles[6] =
                new Hexagon(
                        tiles[5].getCenterX() + TILE_RADIUS * 2,
                        tiles[5].getCenterY(),
                        6,
                        points[13],
                        points[14],
        ...
        tiles[7] =
                new Hexagon(
                        tiles[3].getCenterX() - TILE_RADIUS,
        ...
        tiles[8] =
                new Hexagon(
                        tiles[7].getCenterX() + TILE_RADIUS * 2,
                        tiles[7].getCenterY(),
                        8,
                        points[18],
                        points[19],
        ...
        tiles[9] =
                new Hexagon(
                        tiles[8].getCenterX() + TILE_RADIUS * 2,
                        tiles[8].getCenterY(),
                        9,
                        points[20],
                        points[21],
        ...
        tiles[10] =
                new Hexagon(
                        tiles[9].getCenterX() + TILE_RADIUS * 2,
                        tiles[9].getCenterY(),
                        10,
                        points[22],
                        points[23],
        ...
        tiles[11] =
                new Hexagon(
                        tiles[10].getCenterX() + TILE_RADIUS * 2,
                        tiles[10].getCenterY(),
                        11,
                        points[24],
                        points[25],
        ...
        tiles[12] =
                new Hexagon(
                        tiles[3].getCenterX(),
                        tiles[7].getCenterY() + TILE_RADIUS + (TILE_RADIUS / 2),
                        12,
                        points[28],
                        points[29],
                        points[30],
        ...
        tiles[13] =
                new Hexagon(
                        tiles[12].getCenterX() + TILE_RADIUS * 2,
                        tiles[12].getCenterY(),
                        13,
                        points[30],
                        points[31],
        ...
        tiles[14] =
                new Hexagon(
                        tiles[13].getCenterX() + TILE_RADIUS * 2,
                        tiles[13].getCenterY(),
                        14,
                        points[32],
                        points[33],
        ...
        tiles[15] =
                new Hexagon(
                        tiles[14].getCenterX() + TILE_RADIUS * 2,
                        tiles[14].getCenterY(),
                        15,
                        points[34],
                        points[35],
        ...
        tiles[16] =
                new Hexagon(
                        tiles[0].getCenterX(),
                        tiles[12].getCenterY() + TILE_RADIUS + (TILE_RADIUS / 2),
                        16,
                        points[39],
                        points[40],
                        points[41],
        ...
        tiles[17] =
                new Hexagon(
                        tiles[16].getCenterX() + TILE_RADIUS * 2,
                        tiles[16].getCenterY(),
                        17,
                        points[41],
                        points[42],
        ...
        tiles[18] =
                new Hexagon(
                        tiles[17].getCenterX() + TILE_RADIUS * 2,
                        tiles[17].getCenterY(),
                        18,
                        points[43],
                        points[44],
    ...
    private void assignSlots(
            int tileNumber, int slot1, int slot2, int slot3, int slot4, int slot5, int slot6) {
        Point[] temp;
        // Tile #1
